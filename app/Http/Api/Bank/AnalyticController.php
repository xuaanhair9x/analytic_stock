...
class AnalyticController extends Controller
{
     ...
     */
    public function roaOfOneBankOnYears(string $companyCode,array $years)
    {
     ...
     * @return false|string
     */
    public function roaOfManyBankOnManyYears(Request $request)
    {
        /**
         * Expect data company_code: 'MBB,VCB,ACB'
         * Expect data years: '2016,2017,2018,2019,2020'
         */
        $banks = explode(',',$request->query('company_code'));
        $years = explode(',',$request->query('years'));
        $data = [];
        foreach ($banks as $bank)
        {
            $data[$bank] = $this->roaOfOneBankOnYears($bank,$years);
        }
        $dataView['title'] = 'Chỉ số ROA của các ngân hàng qua các năm';
        $dataView['data'] = $data;
        $dataView['axis_y'] = 'Tỷ lệ chỉ số ROA';
        $dataView['suffix'] = '%';
        return  view('bank/Analytic/Api/ChartLineManyCompanyOnManyYears',['dataView' => $dataView]);
    }
     ...
     * @return \Illuminate\Support\Collection
     */
    public function nimOfOneBankOnYears($companyCode, $years)
    {
        $mainTable = $this->tableBankIncomeStatementInfoYear;
     ...
     * @return false|string
     */
    public function nimOfManyBankOnManyYears(Request $request)
    {
        /**
         * Expect data company_code: 'MBB,VCB,ACB'
         * Expect data years: '2016,2017,2018,2019,2020'
        ...
        foreach ($banks as $bank)
        {
            $data[$bank] = $this->nimOfOneBankOnYears($bank, $years);
        }
     ...
     * @return \Illuminate\Support\Collection
     */
    public function roeOfOneBankOnYears($companyCode,$years)
    {
        $mainTable = $this->tableBankIncomeStatementInfoYear;
        $indicatorNetIncomeAfterTax = 21;
     ...
     * @return false|string
     */
    public function roeOfManyBankOnManyYears(Request $request)
    {
        /**
         * Expect data company_code: 'MBB,VCB,ACB'
         * Expect data years: '2016,2017,2018,2019,2020'
        ...
        foreach ($banks as $bank)
        {
            $data[$bank] = $this->roeOfOneBankOnYears($bank,$years);
        }
     ...
     */
    public function NonInterestIncomeAndIncomeFromService(Request $request)
    {
        /**
         * Expect data company_code: 'MBB,VCB,ACB'
         * Expect data years: '2016,2017,2018,2019,2020'
        ...
        $dataView['main_label'] = [ $companyCode , 'Non-Interest Income', 'Income From Service', 'Other Income'];
        $dataView['title'] = __('Income structure');
        $dataView['sub_title'] = __('Analysis results of a bank over the years');
        $dataView['data'] = $data;
        return view('bank/Analytic/Api/NonInterestIncomeAndIncomeFromService',['dataView' => $dataView]);
    }

    /**
     * Lợi nhuận sau thuế của các ngân hàng trong 1 năm
     */
    public function netIncomeAfterTaxManyComanyOnOneYear(Request $request)
    {
        /**
         * Expect data company_code: 'MBB,VCB,ACB'
         * Expect data years: '2016,2017,2018,2019,2020'
        ...
        return view('bank/Analytic/Api/AmountOfManyCompanyOnOneYear',['dataView' => $dataView]);
    }

    /**
     * Chỉ số cir của các ngân hàng qua các năm
     */
    public function costToIncomeRatio(Request $request)
    {
        /**
         * Expect data company_code: 'MBB,VCB,ACB'
         * Expect data years: '2016,2017,2018,2019,2020'
     ...
     * Của 1 công ty qua các năm.
     */
    public function NetProfitAfterTaxAndIncreasement(Request $request)
    {
        /**
         * Expect data company_code: 'MBB,VCB,ACB'
         * Expect data years: '2016,2017,2018,2019,2020'
        ...
        $dataView['data'] = $data;
        $dataView['title'] = __('Profit after tax and growth Profit after tax: '.$companyCode );
        return view('bank/Analytic/Api/IncreasePercentAndAmount',['dataView' => $dataView]);
    }

    /**
     * Doanh thu thuần và tăng trưởng doanh thu thuần.
     */
    public function NetInterestIncomeAndIncreasement(Request $request)
    {
        /**
         * Expect data company_code: 'MBB,VCB,ACB'
         * Expect data years: '2016,2017,2018,2019,2020'
        ...
        $data = DB::table( $mainTable,'main_table')
            ...
            ->select(
                ...
                DB::raw("(SELECT (main_table.value - child.value)/child.value*100  FROM {$mainTable} as child
                                ...
                                and child.year = (main_table.year-1)) as increase_value"))->get();
        $dataView['data'] = $data;
        $dataView['title'] = __('Net interest income and Net interest income growth: '.$companyCode);
        return view('bank/Analytic/Api/IncreasePercentAndAmount',['dataView' => $dataView]);
    }
     ...
     */
    public function LoanToDeposit(Request $request)
    {
        /**
         * Expect data company_code: 'MBB,VCB,ACB'
         * Expect data years: '2016,2017,2018,2019,2020'
         */
        $companyCodes = explode(',',$request->query('company_code'));
        $years = explode(',',$request->query('years'));
        ...
        $dataView['data'] = $data;
        $dataView['title'] = __('Loan to Deposit ratio (LDR).');
        return view('bank/Analytic/Api/ContingencyCostRatio',['dataView' => $dataView]);
    }
     ...
     */
    public function increaseLoanCustomer(Request $request)
    {
        /**
         * Expect data company_code: 'MBB,VCB,ACB'
         * Expect data years: '2016,2017,2018,2019,2020'
        ...
        return view('bank/Analytic/Api/IncreaseLoanCustomer',['dataView' => $dataView]);
    }
    ...
    public function LoanCustomer(Request $request)
    {
        ...
        return view('bank/Analytic/Api/LoanCustomer',['dataView' => $dataView]);
    }

    /**
     * Chi phí dự phòng rủi ro tín dụng.
     */
    public function contingencyCost(Request $request)
    {
        /**
         * Expect data company_code: 'MBB,VCB,ACB'
         * Expect data years: '2016,2017,2018,2019,2020'
        ...
        $dataView['data'] = $data;
        $dataView['title'] = 'Ngân hàng '. $companyCode ;
        $dataView['legendText'] = 'Provision for Credit Losses';
        return view('bank/Analytic/Api/LoanCustomer',['dataView' => $dataView]);
    }
     ...
     */
    public function casaRatio(Request $request)
    {
        /**
         * Expect data company_code: 'MBB,VCB,ACB'
         * Expect data years: '2016,2017,2018,2019,2020'
     ...
     */
    public function depositsFromCustomerRatio(Request $request)
    {
        /**
         * Expect data company_code: 'MBB,VCB,ACB'
         * Expect data years: '2016,2017,2018,2019,2020'
     ...
     */
    public function depositsFromCustomerAndCasa(Request $request)
    {
        /**
         * Expect data company_code: 'MBB,VCB,ACB'
         * Expect data years: '2016,2017,2018,2019,2020'
        ...
        $dataView['data'] = $data;
        return view('bank/Analytic/Api/DepositsFromCustomersAndCasa',['dataView' => $dataView]);
     ...
     */
    public function contingencyCostRatio(Request $request)
    {
        /**
         * Expect data company_code: 'MBB,VCB,ACB'
         * Expect data years: '2016,2017,2018,2019,2020'
        ...
        $dataView['data'] = $data;
        $dataView['title'] = __('Provision for Credit Losses ratio.');
        return view('bank/Analytic/Api/ContingencyCostRatio',['dataView' => $dataView]);
    }
     ...
     */
    public function LoanOfBankByYears(Request $request)
    {
        /**
         * Expect data company_code: 'MBB,VCB,ACB'
         * Expect data years: '2016,2017,2018,2019,2020'
        ...
        return view('bank/Analytic/Api/LoanOfBank',['dataView' => $dataView]);
    }

    /**
     * Cho vay của nhiều ngân hàng trong 1 năm.
     */
    public function LoanOfBankByBanks(Request $request)
    {
        /**
         * Expect data company_code: 'MBB,VCB,ACB'
         * Expect data years: '2016,2017,2018,2019,2020'
         */
        $bankCodes = explode(',',$request->query('company_code'));
        $years = explode(',',$request->query('years'));
        $year = $years[0];
        $newMapping = array_flip(self::MAPPING_DEBIT_ID);
        foreach ($newMapping as $key => $mapping) {
     ...
     */
    public function badDebtBankRatio(Request $request) {
