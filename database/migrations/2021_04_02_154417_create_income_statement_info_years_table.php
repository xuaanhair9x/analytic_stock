...
class CreateIncomeStatementInfoYearsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create($this->tableBankIncomeStatementInfoYear, function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists($this->tableBankIncomeStatementInfoYear);
    }
}
