...
class BankBalanceSheetBankTable extends Migration
{
    ...
    public function up()
    {
        Schema::create($this->tableBankBalanceSheetInfoYear, function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists($this->tableBankBalanceSheetInfoYear);
    }
}
